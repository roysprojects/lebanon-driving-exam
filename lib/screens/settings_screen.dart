...
import 'package:lebanon_driving_exam/providers/theme_provider.dart'; // Added import
...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final currentThemeMode = ref.watch(themeNotifierProvider); // Access theme mode
    final themeNotifier = ref.read(themeNotifierProvider.notifier); // Access notifier
